  ...
  return (
    <div className="bg-white p-4 2xl:p-6 rounded-xl border border-slate-200 shadow-sm">
      <div className="flex items-center justify-between mb-4 2xl:mb-6">
        <h2 className="text-base 2xl:text-lg font-bold text-slate-900 tracking-tight">Live Order Overview</h2>
        <span className="text-[10px] 2xl:text-xs font-medium text-emerald-600 bg-emerald-50 px-2 2xl:px-2.5 py-1 rounded-full animate-pulse flex items-center gap-1.5">

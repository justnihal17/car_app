...
export function FileUpload({ name, label }: { name: string, label: string }) {
  ...
  return (
    <div className="space-y-2">
      ...
      <div className={`border-2 border-dashed rounded-2xl p-6 text-center transition-all ${file ? 'border-blue-400 bg-red-50' : 'border-slate-200 hover:border-blue-400 bg-slate-50'}`}>
        {file ? (
            ...
            <>
                ...
                <p className="text-sm text-slate-600">Drag & drop or <span className="text-red-600 font-medium">browse</span></p>

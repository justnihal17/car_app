      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="space-y-1">
          ...
          <select {...register(`addresses.${index}.city`)} className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm text-slate-900 outline-none focus:border-red-500 transition-colors">
            ...
            <option value="Al Aqah">Al Aqah</option>
            <option value="Al Bidyah">Al Bidyah</option>
            <option value="Al Hamriyah">Al Hamriyah</option>
            <option value="Al Jazirah Al Hamra">Al Jazirah Al Hamra</option>
            <option value="Al Manama">Al Manama</option>
            <option value="Al Raas">Al Raas</option>
            <option value="Al Rams">Al Rams</option>
            ...
            <option value="Khatt">Khatt</option>
